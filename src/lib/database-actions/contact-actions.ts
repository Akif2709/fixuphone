 ...
 */
export async function updateContactInfo(updateData: Partial<CreateContactInfoRequest>): Promise<{ success: true; data: SerializedContactInfo } | { success: false; error: string }> {
  try {
 ...
 */
export async function upsertContactInfo(data: CreateContactInfoRequest): Promise<{ success: true; data: SerializedContactInfo } | { success: false; error: string }> {
  try {
